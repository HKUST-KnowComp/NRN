...
class GQE(model.IterativeModel):
    def __init__(self, num_entities, num_relations, embedding_size, number_encoder_list=None, label_smoothing=0.1, 
        ...
        super(GQE, self).__init__(num_entities, num_relations, embedding_size)
    ...
    def attribute_projection(self, attribute_ids, sub_query_encoding):
        ...
        relation_transition = attribute_embeddings
        ...
        # print("attribute_projection output shape:", projected_particles.shape)
    ...
    def numerical_projection(self, numerical_proj_ids, sub_query_encoding):
        ...
        relation_transition = numerical_embeddings
    ...
    def forward(self, batched_structured_query, label=None):
        ...
        assert batched_structured_query[0] in ["p", "e", "i", "u",  "ap", "rp", "rap", "np", "nv"]
...
def unit_test():
    ...
    q2p_model = GQE(num_entities=nentity,
