...
if __name__ == "__main__":
    ...
    train_log_dir = '../logs/gradient_tape/' + current_time + "_" + args.model + "_" + data_name + '_baseline'
    test_log_dir = '../logs/gradient_tape/' + current_time + "_" + args.model + "_" + data_name + '_baseline'
