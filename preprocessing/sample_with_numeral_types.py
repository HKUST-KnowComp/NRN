...
def sample_all_data(id):
    ...
    for data_dir in n_queries_train_dict.keys():
        ...
        with open(
                "../sampled_data/" + data_dir + "_train_queries_" + str(id) + "_with_units.json",
                "w") as file_handle:
        ...
        with open(
                "../sampled_data/" + data_dir  + "_valid_queries_" + str(id) + "_with_units.json",
                "w") as file_handle:
        ...
        with open(
                "../sampled_data/" + data_dir +  "_test_queries_" + str(id) + "_with_units.json",
                "w") as file_handle:
